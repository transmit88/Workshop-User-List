...
export const UserItem = ({
    ...
    const blancProfiUrl = 'https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460__340.png';
    ...
    return (
        ...
        <Fragment>
            ...
            <td>
                <img src={user.imageUrl || blancProfiUrl} alt={`${user.firstName}'s profile`} className="image" />
            </td>
